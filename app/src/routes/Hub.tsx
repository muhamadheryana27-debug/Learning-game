...
export default function Hub() {
  ...
  return (
    <div className="min-h-screen bg-[#FDF6E3] flex items-center justify-center p-2 sm:p-4 md:p-6 relative overflow-hidden">
      {/* Warm wooden pattern — match Briefing */}
      ...
      >
        {/* ── Top Banner — Tycoon Command Center ── */}
        ...
        <div className="p-4 sm:p-6 md:p-8 space-y-5 md:space-y-6">
          {/* ── 1. PLAYER BADGE HEADER (CARD BADGE) ── */}
          <div className="rounded-2xl sm:rounded-[1.5rem] border-[3px] border-slate-800 bg-slate-900 p-3 sm:p-4 flex items-center gap-3 sm:gap-4 shadow-xl relative overflow-hidden">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap gap-1.5 mt-1">
                <span className="inline-flex items-center gap-1 text-[11px] sm:text-xs font-bold bg-white text-slate-900 px-2.5 py-1 rounded-full border-2 border-slate-200">🏫 Kelas: {student.class}</span>
                <span className="inline-flex items-center gap-1 text-[11px] sm:text-xs font-bold bg-amber-400 text-slate-900 px-2.5 py-1 rounded-full border-2 border-amber-600">🔢 No. Absen: {student.absen}</span>
              </div>
            </div>
          ...
          {/* ── 2. STORY QUEST LOG — Pak Taro Speech Bubble ── */}
