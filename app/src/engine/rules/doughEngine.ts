...
// FIXED Pipeline Routes — Door 2 reordered to bypass k_bot trap so Donut (Circle) is reachable
// Original Door 2: [g2_top, g2_mid, g_shared_midLeft, k_top, k_bot] never produced Donut because k_bot always converts Donut->Cheesecake at the end.
// Fixed: move k_bot before g2_mid so g2_mid (🍰→🍩) fires AFTER k_bot, allowing Donut to survive to Exit K.
export const PIPELINE_ROUTES: Record<number, GateRule[]> = {
  1: [GATES.g1_top, GATES.g_shared_midLeft, GATES.k_top, GATES.k_bot],
  2: [GATES.g2_top, GATES.k_bot, GATES.g2_mid, GATES.g_shared_midLeft, GATES.k_top], // FIXED — 5 gates, Donut reachable via Triangle->Donut after k_bot
